...
- use British spelling by default if the target is IEEE-style prose
- keep figure legends concise; if aiming for IEEE style, `<= 300` words is a good upper bound
- if aiming for IEEE style, keep titles at `<= 75` characters including spaces

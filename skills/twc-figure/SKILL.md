...
name: twc-figure
description: >-
  Submission-grade IEEE/high-impact journal figure workflow for Python or R. Use whenever the user asks to create, revise, audit, or polish manuscript figures, multi-panel scientific plots, figures4papers-style matplotlib plots, or journal-ready SVG/PDF/TIFF outputs, especially for IEEE Transactions on Wireless Communications and related venues. Before plotting, define the figure's conclusion, evidence logic, export needs, and review risks. If the user has not chosen Python or R, ask "Python or R?" and stop. Use only the selected backend for figure generation, previewing, exporting, and QA. Supports matplotlib/seaborn and ggplot2/patchwork/ComplexHeatmap. Not for dashboards or Illustrator/Figma-first infographics.
---
...
For dense IEEE-style figure pages, use the low-saturation pastel
...
- When the user asks for broad `IEEE` style rather than ML-specific style, read `references/twc-2026-observations.md` before choosing layout.
...
- Python or R figures for **papers, slides, or reports** targeting IEEE journals, NeurIPS, ICLR, or similar venues.
- Requests involving **grouped bars, trend lines, heatmaps, radar plots, multi-panel grids**, or **PDF/SVG/high-DPI** output.
- Any mention of "IEEE style", "publication figure", "paper figure", "SCI figure", "figures4papers", "scientific-figure-making", "R plotting template", or "high-quality scientific plot".
...
| [references/twc-2026-observations.md](references/twc-2026-observations.md) | Real IEEE journal page archetypes: schematic-led composites, quantitative grids, multi-panel layouts |

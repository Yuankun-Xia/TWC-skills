...
Submission-grade scientific figures for IEEE-tier journals and high-impact academic venues,
...
(published in *IEEE* and top ML/bioinformatics venues).
...
inside a larger IEEE-style result figure.
...
**Unified palette policy (recommended for recent IEEE-style layouts)**  

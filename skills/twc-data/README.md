...
citations, and FAIR metadata checks in a Nature / IEEE publication style.
...
- aligns Chinese author intent with IEEE-style English availability wording

## Source hierarchy

- IEEE Xplore and IEEE research data policies
- IEEE Xplore reporting standards for availability of data, code, materials, and protocols
...
- preparing a Data Availability statement for a IEEE journal or Springer IEEE journal

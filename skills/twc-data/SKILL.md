...
name: twc-data
description: >-
  Prepare, audit, or revise journal-ready Data Availability statements, data repository plans,
  dataset citations, and FAIR metadata checklists for manuscripts. Use when the user asks about
  data availability statements, research data sharing, repository selection, accession numbers,
  ...
  wording for Chinese-speaking authors preparing IEEE journal submissions.
---

# IEEE Data Availability Skill

Use this skill to turn a manuscript's supporting data into a transparent, IEEE-ready data
availability package: statement text, repository plan, dataset citations, and missing-information
flags.

The governing policy layer is IEEE / IEEE Xplore data policy. The implementation
...
- Translate intent, not wording. Chinese phrases such as "可向通讯作者索取" are usually too vague
  for IEEE-style English unless the restriction and access process are specified.
...
| File | Open when |
|---|---|
| [references/policy-principles.md](references/policy-principles.md) | You need the governing Nature/IEEE data-sharing rules or edge-case policy logic |
...
2. IEEE Xplore / IEEE data, code, materials, and reporting policies.

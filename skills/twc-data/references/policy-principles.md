...
Use this file when deciding what a IEEE-ready data statement must disclose.
...
- IEEE research data policy requires Data Availability statements for original articles
  and asks authors to describe available data, location, and access terms.
- IEEE Xplore reporting standards require prompt availability of data, materials, code, and

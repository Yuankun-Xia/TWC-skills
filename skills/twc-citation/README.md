...
A citation-search skill for turning manuscript text or standalone claims into strict Nature / IEEE reference exports with segment-level mapping and reference-manager-ready downloads.
...
- filters results to IEEE Xplore, the AAAS Science family, Cell Press, or flagship-only scope
...
- Official publisher pages from IEEE Xplore, AAAS Science, and Cell Press

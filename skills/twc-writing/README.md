...
A IEEE-style manuscript writing skill for drafting or rebuilding sections from
author-provided claims, figures, results, notes, or Chinese drafts.

## What it does

`twc-writing` helps write:
...
of an existing draft, use `twc-polishing`.

## Built from

Close reading of curated IEEE and top communications journals research articles

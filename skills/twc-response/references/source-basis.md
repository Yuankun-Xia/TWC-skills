...
Use this file to keep `twc-response` grounded in primary or near-primary publication
...
2. Nature / IEEE Xplore / Springer IEEE peer-review and editorial-process pages.
3. Springer IEEE editorial advice on rebuttal letters.
...
- Do not overstate source authority: IEEE advice is useful writing guidance, not journal-specific binding policy.

...
PowerPoint decks with a IEEE-style evidence narrative.
...
- IEEE-style scientific reporting logic: problem, gap, claim, evidence, validation,
...
- summarising a IEEE journal paper into Chinese slides

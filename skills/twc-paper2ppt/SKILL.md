...
# Style Rules
Use a restrained IEEE-style academic presentation design:
...
Borrow IEEE-style figure-page composition principles, but keep this skill self-contained and independent from any other skill. Treat each slide like a publication figure page: one dominant idea, one clear evidence hierarchy, and asymmetry when the story needs it.

### IEEE-style page composition
